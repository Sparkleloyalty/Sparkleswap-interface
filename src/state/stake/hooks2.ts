...
import { STAKING_REWARDS_INTERFACE_2 } from '../../constants/abis/staking-rewards2'
...
export function useStakingInfo2(pairToFilterBy?: Pair | null): StakingInfo[] {
  ...
  const balances = useMultipleContractSingleData(rewardsAddresses, STAKING_REWARDS_INTERFACE_2, 'balanceOf', accountArg)
  const earnedAmounts = useMultipleContractSingleData(rewardsAddresses, STAKING_REWARDS_INTERFACE_2, 'earned', accountArg)
  const totalSupplies = useMultipleContractSingleData(rewardsAddresses, STAKING_REWARDS_INTERFACE_2, 'totalSupply')

  // tokens per second, constants
  const rewardRates = useMultipleContractSingleData(
    rewardsAddresses,
    STAKING_REWARDS_INTERFACE_2,
    'rewardRate',
    undefined,
    NEVER_RELOAD
  )
