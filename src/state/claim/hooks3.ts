...
import { useMerkleDistributorContract } from '../../hooks/useContract3'
...
export function useUserUnclaimedAmount(account: string | null | undefined): TokenAmount | undefined {
  ...
  if (!canClaim || !userClaimData) {
    return new TokenAmount(unicorn, JSBI.BigInt(0))
  }
  return new TokenAmount(unicorn, JSBI.BigInt(userClaimData.amount))
}
