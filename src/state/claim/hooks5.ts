...
import { useMerkleDistributorContract } from '../../hooks/useContract5'
...
export function useUserUnclaimedAmount(account: string | null | undefined): TokenAmount | undefined {
  ...
  if (!canClaim || !userClaimData) {
    return new TokenAmount(wing, JSBI.BigInt(0))
  }
  return new TokenAmount(wing, JSBI.BigInt(userClaimData.amount))
}
