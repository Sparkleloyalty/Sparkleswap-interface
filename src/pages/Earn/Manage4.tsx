...
import StakingModal from '../../components/earn/StakingModal4'
import { useStakingInfo4 } from '../../state/stake/hooks4'
import UnstakingModal from '../../components/earn/UnstakingModal4'
import ClaimRewardModal from '../../components/earn/ClaimRewardModal4'
...
import { useTotalSupply } from '../../data/TotalSupply4'
...
export default function Manage4({
  match: {
  ...
  const stakingInfo = useStakingInfo4(stakingTokenPair)?.[0]
