...
export const SPRKL = new Token(ChainId.MAINNET, '0x4b7ad3a56810032782afce12d7d27122bdb96eff', 8, 'SPRKL', 'Sparkle')

// Additional Currencies
export const EMOJI = new Token(ChainId.MAINNET, '0xa3a7cba479df86c7f866280b90ebc3b25f2371f0', 18, '✨', 'Sparkleswap Rewards Token')
export const UNICORN = new Token(ChainId.MAINNET, '0xe62174753ea3275f65f4cf980dc002fea7887ea8', 18, '🦄', 'Unicorn')
...
const UNI_ADDRESS = '0xe62174753ea3275f65f4cf980dc002fea7887ea8'
export const Unicorn: { [chainId in ChainId]: Token } = {
  [ChainId.MAINNET]: new Token(ChainId.MAINNET, UNI_ADDRESS, 18, '🦄', 'Unicorn'),
  [ChainId.RINKEBY]: new Token(ChainId.RINKEBY, UNI_ADDRESS, 18, '🦄', 'Unicorn'),
  [ChainId.ROPSTEN]: new Token(ChainId.ROPSTEN, UNI_ADDRESS, 18, '🦄', 'Unicorn'),
  [ChainId.GÖRLI]: new Token(ChainId.GÖRLI, UNI_ADDRESS, 18, '🦄', 'Unicorn'),
  [ChainId.KOVAN]: new Token(ChainId.KOVAN, UNI_ADDRESS, 18, '🦄', 'Unicorn')
}
